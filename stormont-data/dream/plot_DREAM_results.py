...
RFs = [True, True, True, True, True]
# RFs = [False]

burnins = [20000, 20000, 20000, 20000, 20000]

bores = [
    "DBT10_4param_TEST_uniform",
    "DBT11_4param_TEST_uniform",
    "DBT12_4param_TEST_uniform",
    "DBT13_4param_TEST_uniform",
    "L4B01_4param_TEST_uniform",
]

for burnin, bore, READ_FINAL in zip(burnins, bores, RFs):

    # read in MATLAB .mat file
    base = f"powerlaw_{bore}"
    print(base)
    if READ_FINAL:
